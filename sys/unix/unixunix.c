...
# ifndef SDL_GRAPHICS
	/* The SDL backend takes its input from the window, not fd 0, so
	   this test would only be asking whether the shell that launched
	   the game happened to have a terminal. */
