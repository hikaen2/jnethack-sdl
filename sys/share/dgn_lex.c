...
#  endif
# endif
/* MinGW-w64 does not go through unixconf.h, so POSIX_TYPES is not set for
   it, but the bodies further down are still the void ones. */
# if !defined(VOIDYYPUT) && defined(__MINGW32__)
#  define VOIDYYPUT
# endif
